export default function Featured() {
  ...
  const cardImages = [
    ...
    "https://img.freepik.com/free-photo/programming-background-with-person-working-with-codes-computer_23-2150010130.jpg?ga=GA1.1.1362237040.1750501614&semt=ais_incoming&w=740&q=80",
    ...
    <div className="w-full py-20 bg-orange-100">
      ...
      <div className="text-center pb-10">
        ...
        <p className="text-gray-600 mt-4 text-lg">
          These featured projects reflect our students ability to combine
          innovative thinking with practical development skills. <br /> From
          intuitive designs to scalable tech solutions, each project is built to
          solve real problems while showcasing creativity and purpose.
        </p>
      </div>
