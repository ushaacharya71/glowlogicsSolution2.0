  ...
  return (
    <div className="min-h-screen bg-orange-100 p-8 flex flex-col items-center pt-32">
      <div className="max-w-3xl w-full bg-white shadow-xl rounded-2xl p-8 mb-10">
        {/* Heading */}
        <h1 className="text-4xl font-extrabold font-[Poppins]  text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-yellow-500">
          VTU Internship Certificate Verification
        </h1>
