  ...
  return (
    <div className="bg-white min-h-screen px-6 md:px-16 py-10 text-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        {/* Left text section */}
        <div className="space-y-6 text-sm md:text-base whitespace-pre-line">

          <div>
            <h2 className="text-xl font-bold mb-2">Introduction</h2>
            <p>
              This Privacy Policy describes how Glowlogics Solutions private limited and its affiliates (collectively Glowlogics Solutions private limited , we, our, us) collect, use, share, protect or otherwise process your information/ personal data through our website https://www.glowlogics.in/ (hereinafter referred to as Platform ).
              Please note that you may be able to browse certain sections of the Platform without registering with us.We do not offer any service under this Platform outside India and your personal data will primarily be stored and processed in India. By visiting this Platform, providing your information or availing any service offered on the Platform, you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use and the applicable service terms and conditions, and agree to be governed by the laws of India including but not limited to the laws applicable to data protection and privacy. If you do not agree please do not use or access our Platform.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">Grievance Officer</h2>
            <p>
              Aditi{"\n"}
              Branch Manager{"\n"}
              Glowlogics Solutions Pvt Ltd{"\n"}
              #4-59/9, 1st floor, Ekka Complex, Nagori{"\n"}
              Mangalore Karnataka 575002{"\n"}
              Contact us: 9620294767{"\n"}
