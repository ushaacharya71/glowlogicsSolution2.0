    ...
    <div className="min-h-screen bg-orange-100 py-10 px-4 overflow-hidden pt-28">
      ...
      <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-8 mb-16 px-5">
        {[
          ...
          {
            title: "AmbitionBox",
            img: "https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/96/55/ce/9655ce9c-ee40-f964-2d9c-826012c8e0b6/AppIcon-0-0-1x_U007emarketing-0-11-0-85-220.png/1200x630wa.png",
