    ...
    <div className="bg-white min-h-screen px-6 md:px-16 py-10 text-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-6 text-sm md:text-base text-justify">
          ...
          <p>{`The Platform is owned by Glowlogics Solutions private limited, a company incorporated under the Companies Act, 1956 with its registered office at Building No:148, 2nd Floor,Outer Ring Rd, Jakkasandra, HSR Layout 5th Sector, Bengaluru, Karnataka 560102 (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').`}</p>
